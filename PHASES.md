...
### MV-Phase 3: List panel (Complete — signals 5/8/17 closed 2026-05-03; signals 18/19 ⏳ on deferred RTSTRUCT save-load fixture)
...
**Phase 3 closure gate**: signals 5, 8, 17, 18, 19 must all be ✅. Status as of 2026-05-03: **5 ✅** ([`g5-per-viewport-hide.test.ts`](src/renderer/lib/cornerstone/__tests__/g5-per-viewport-hide.test.ts)), **8 ✅** ([`12-g2-g8-acceptance.e2e.ts`](e2e/specs/12-g2-g8-acceptance.e2e.ts)), **17 ✅** ([`g17-active-member-append.test.ts`](src/renderer/lib/cornerstone/__tests__/g17-active-member-append.test.ts)), **18 / 19** still service-integration-only with E2E deferred on the RTSTRUCT save-load fixture (acceptable per the documented fixture blocker). Phase 3 closure gate satisfied.
