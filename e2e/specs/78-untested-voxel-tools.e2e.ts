/**
 * Signal 29 — effect coverage for the segmentation tools spec 43 left out.
 *
 * A 2026-09 audit found 17 of 25 selectable annotation tools had no test proving they
 * do ANYTHING: six rested on spec 16, which asserts only that the active tool name
 ...
 *
 * This spec closes the deterministic, non-GPU half of that list, using spec 43's
 ...
 *
 * (Region / Region+ are GPU growcut and stay out for the reason spec 43 gives.)
 */
 ...
 *
 * The regression guard lives in spec 33 with the other planned-tool assertions: the
