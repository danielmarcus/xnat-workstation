...
const SEG_TOOLS: ToolDef[] = [
  ...
  { id: 'dynamicThreshold', label: 'Dyn. Thresh', title: 'Threshold sphere brush that also drops disconnected specks (island removal)', icon: S(<><circle cx="8" cy="8" r="3.8" /><path d="M5 8h6" strokeDasharray="1.5 1" /></>) },
  { id: 'sphereBrush', label: 'Sph. Brush', title: 'Spherical brush — a 3D kernel, so one stroke also reaches neighbouring slices', icon: S(<><circle cx="8" cy="8" r="4" /><ellipse cx="8" cy="8" rx="4" ry="1.7" /></>) },
  { id: 'sphereEraser', label: 'Sph. Eraser', title: 'Spherical eraser — erases across neighbouring slices too', icon: S(<><circle cx="8" cy="8" r="4" /><ellipse cx="8" cy="8" rx="4" ry="1.7" /><path d="M5 11l6-6" /></>) },
  { id: 'sphereThreshold', label: 'Sph. Thresh', title: 'Spherical brush limited to the intensity window', icon: S(<><circle cx="8" cy="8" r="4" /><ellipse cx="8" cy="8" rx="4" ry="1.7" /></>) },
