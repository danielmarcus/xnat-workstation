 ...
 *    as did Circle Cut and Circle ROI.
 ...
 *    Circle Cut does not offer a brush radius it ignores.
 */
...
const SEG_TOOLS: ToolDef[] = [
  ...
  { id: 'circleScissors', label: 'Circle Cut', title: 'Drag a circle; everything inside it joins the segment', icon: S(<><circle cx="8" cy="8" r="5" /><path d="M2 14l4-4" /></>) },
  { id: 'rectangleScissors', label: 'Rect Cut', title: 'Drag a rectangle; everything inside it joins the segment', icon: S(<><rect x="3" y="4" width="10" height="8" rx="1" /><path d="M2 14l3-3" /></>) },
  { id: 'sphereScissors', label: 'Sphere Cut', title: 'Drag a sphere; everything inside it joins the segment, across slices', icon: S(<><circle cx="8" cy="8" r="5" /><ellipse cx="8" cy="8" rx="5" ry="2" /></>) },
