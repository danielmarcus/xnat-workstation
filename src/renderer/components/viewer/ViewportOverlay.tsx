 ...
 * kept live by useViewport's state-sync. No service / Cornerstone imports (§2);
 * components read stores directly.
 *
 * This restores the readouts the deleted ViewportOverlay rendered (P1.8d removed
 * it without replacement). Orientation edge-markers, rulers, and the crosshair
 * reticle are intentionally NOT here yet — they ride with the world-point
 * crosshair work.
 *
