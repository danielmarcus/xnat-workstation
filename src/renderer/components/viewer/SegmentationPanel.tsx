...
export default function SegmentationPanel({ sourceImageIds }: SegmentationPanelProps) {
  ...
  const handleSaveLocal = useCallback(async (
    ...
    try {
      ...
      // Phase 4.6: under the write-through model (design §B5), all
      // interpolated contours are auto-accepted at generation time.
      // The legacy "Unaccepted Interpolated Contours" dialog is gone.
  ...
  const handleUploadXnat = useCallback(async (
    ...
    // Phase 4.6: under the write-through model (design §B5), all
    // interpolated contours are auto-accepted at generation time. The
    // pre-upload acceptance dialog is gone.
