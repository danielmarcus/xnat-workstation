 ...
 *
 * Phase 4.3: memos for `autoGenerated` annotations (= contours
 * produced by inter-slice interpolation) are diverted into the
 * auto-generated buffer rather than recorded as individual entries.
 * The interpolationUndo handler drains the buffer into a single
 * batched HistoryEntry on
